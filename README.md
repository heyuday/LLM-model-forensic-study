...
- **Odd Number**
  The best interpretation is in-context task gaming, not literal reward hacking. The interesting models seem to treat reward-like fields as the real objective when those fields look live.
